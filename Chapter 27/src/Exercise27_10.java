...
public class Exercise27_10 extends JApplet {
	public Exercise27_10() {
	...
	public static void main(String[] args) {
		JFrame frame = new JFrame("BST Tree Search Path");
		JApplet applet = new Exercise27_10();
		frame.add(applet);
...
class BinaryTreeSearchVisualization extends JPanel {
	...
	public BinaryTreeSearchVisualization(BST<Integer> tree) {
		this.tree = tree;
	...
	class PaintTree extends JPanel {
		protected ArrayList<BST.TreeNode<Integer>> paths = new ArrayList<BST.TreeNode<Integer>>();
		...
		private void displayTree(Graphics g, BST.TreeNode root, int x, int y, int hGap) {
			if (root != null) {
				// Display root
