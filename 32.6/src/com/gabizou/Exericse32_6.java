...
public class Exericse32_6 extends JApplet {
	/**
	 * 
	 */
	...
	public static void main(String[] args) {
		...
		JApplet applet = new Exericse32_6();
		frame.add(applet);
		frame.setTitle("Exercise32_06");
	...
	AdjustmentListener {
		...
		class Ball extends JPanel implements Runnable {
			...
			private ArrayList<BallState> list = new ArrayList<BallState>();
